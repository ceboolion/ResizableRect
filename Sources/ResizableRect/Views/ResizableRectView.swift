    ...
    public var body: some View {
        ZStack {
            RoundedRectangle(cornerRadius: cornerRadius ?? 0)
                ...
                .position(x: rect.midX + (horizontalPadding / 2), y: rect.midY + (verticalPadding / 2))
        ...
        .onAppear {
            rect = CGRect(x: 0, y: 0, width: rectViewWidth - horizontalPadding, height: rectViewHeight - verticalPadding)
        }
    }
...
#Preview {
    ResizableRectView(rectViewWidth: UIScreen.width - 16, rectViewHeight: 600, horizontalPadding: 16, cornerRadius: 16)
}
